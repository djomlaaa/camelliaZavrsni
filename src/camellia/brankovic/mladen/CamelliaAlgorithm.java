...
public class CamelliaAlgorithm {
	...
	public int[] subkey = new int[24 * 4];
...
/*pocetak neparnih rundi*/
	...
	private final void setkey(boolean forEncryption, byte[] key) {
		...
		if (_keyis128) {
			if (forEncryption) {
				 ...
				 * subkey[4]subkey[5] = k3;
				 * subkey[6]subkey[7] = k4;
				 * subkey[8]subkey[9] = k5;
				 * subkey[10]subkey[11] = k6;
				 * subkey[12]subkey[13] = k7;
				 * subkey[14]subkey[15] = k8;
				 * subkey[16]subkey[17] = k9;
				 * subkey[18]subkey[19] = k10;
				 * subkey[20]subkey[21] = k11;
				 * subkey[22]subkey[23] = k12;
				 * subkey[24]subkey[25] = k13;
				 * subkey[26]subkey[27] = k14;
				 * subkey[28]subkey[29] = k15;
				 * subkey[30]subkey[31] = k16;
	...
	* prikaz kad je nulta runda*/
	...
	public boolean is_keyis128() {
		return _keyis128;
	}

	public void set_keyis128(boolean _keyis128) {
		this._keyis128 = _keyis128;
	}
	...
	public static int[] getSbox11110() {
		return SBOX1_1110;
	}

	public static int[] getSbox44404() {
		return SBOX4_4404;
	}

	public static int[] getSbox20222() {
		return SBOX2_0222;
	}
